...
requiredPackages = c('rio','readxl','rJava','xlsx','dplyr','plyr', 'stringi', 'readxl', 'stringr', 'openxlsx', 'xtable')
...
library("openxlsx")
library("xtable")
route<-read_excel("C:/Users/ayushiso/Downloads/temp.xlsx", sheet = 'UPD Portal - North America (NA)')
route<-route[-c(1, 2), ]
...
raw<-read_excel("C:/Users/ayushiso/Downloads/temp.xlsx", sheet = 'Response level')
...
email<-read_excel("C:/Users/ayushiso/Desktop/DSP_Emails_UPD.xlsx")
